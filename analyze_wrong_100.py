...
MODEL_PATH = r"D:\kiri-ocr-finetune\kiri-ocr\output\khmer_id_mixed_v6_bigdata\model.safetensors"
...
def main():
    ...
    ocr = OCR(model_path=MODEL_PATH, device="cpu", decode_method="ctc")
