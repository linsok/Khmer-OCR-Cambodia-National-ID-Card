...
BASE_DIR = Path("data/khmer_mixed_v5")
ERROR_FIX_DIR = Path("data/khmer_error_fix_v2")

OUT_DIR = Path("data/khmer_mixed_v6")
...
def main():
    ...
    print("Mixed v6 dataset created successfully.")
